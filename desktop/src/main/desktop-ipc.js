function registerDesktopIpc(ipcMain, handlers) {
  ...
  handle('file-transfer-targets', () => handlers.fileTransferTargets())
  handle('file-transfer-target-policy', (event, nodeId, updates) => handlers.fileTransferTargetPolicy(nodeId, updates))
  handle('file-transfer-history', () => handlers.fileTransferHistory())
  handle('file-transfer-settings', () => handlers.fileTransferSettings())
  handle('file-transfer-choose-download-dir', () => handlers.fileTransferChooseDownloadDir())
  handle('file-transfer-reset-download-dir', () => handlers.fileTransferResetDownloadDir())
