...
const TOPICS = Object.freeze({
  ...
  APP_NOTIFICATION_REMOVED: 'notification.removed',
  TOTP_SEED: 'totp.seed',
  TOTP_REVOKE: 'totp.revoke',
  TOTP_RESYNC_REQUEST: 'totp.resync_request',
...
const LEGACY_TYPE_TO_TOPIC = Object.freeze({
  ...
  app_notification_removed: TOPICS.APP_NOTIFICATION_REMOVED,
  totp_seed: TOPICS.TOTP_SEED,
  totp_revoke: TOPICS.TOTP_REVOKE,
  totp_resync_request: TOPICS.TOTP_RESYNC_REQUEST,
...
const TOPIC_TO_LEGACY_TYPE = Object.freeze({
  ...
  [TOPICS.APP_NOTIFICATION_REMOVED]: 'app_notification_removed',
  [TOPICS.TOTP_SEED]: 'totp_seed',
  [TOPICS.TOTP_REVOKE]: 'totp_revoke',
  [TOPICS.TOTP_RESYNC_REQUEST]: 'totp_resync_request',
