...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  setFileTransferTargetPolicy: (nodeId, updates) => ipcRenderer.invoke('file-transfer-target-policy', nodeId, updates),
  getFileTransferHistory: () => ipcRenderer.invoke('file-transfer-history'),
  getFileTransferSettings: () => ipcRenderer.invoke('file-transfer-settings'),
  chooseFileTransferDownloadDir: () => ipcRenderer.invoke('file-transfer-choose-download-dir'),
  resetFileTransferDownloadDir: () => ipcRenderer.invoke('file-transfer-reset-download-dir'),
